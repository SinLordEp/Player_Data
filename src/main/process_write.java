...
public class process_write {
    public static void update(FileOperationData current_data) throws Exception {
    ...
    public static void modify_person(FileOperationData current_data){
        try{
    ...
    public static boolean modify_player(FileOperationData current_data) throws Exception {
    ...
    public static Person create_person(FileOperationData current_data) throws Exception {
    ...
    public static Player create_player(FileOperationData current_data) throws Exception {
    ...
    public static int create_ID(FileOperationData current_data)  {
        while (true) {
            try {
    ...
    public static String server_chooser(FileOperationData current_data, String region) throws Exception {
